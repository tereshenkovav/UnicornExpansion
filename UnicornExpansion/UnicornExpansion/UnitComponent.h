...
public:
	...
	// Действия
	void addActionIfAllowed(std::vector<UnitAction>* actions, const std::string& code, const std::string& caption, float fasttime = 1.0) const;
	void addActionIfAllowed(std::vector<UnitAction>* actions, const std::string& code, const std::string& caption, int idx, float fasttime = 1.0) const;
