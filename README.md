...
![UnicornExpansion](screen5.png) ![UnicornExpansion](screen6.png)

В текущей версии, доступен обучающий сценарий и 4 карты мини-кампании, сюжетно
связанные. Кампания поддерживает три уровня сложности. Для разной сложности,
